...
-- First Customer: Bike World

INSERT INTO Customers (
  CustomerName, AddressLine1, City, State, PostalCode, YTDPurchases
)
VALUES (
  'Bike World',
...
-- Activity 6: Creating Transaction and Category Tables
...
-- Activity 7: Creating Database Intersection Tables
...
CREATE TABLE InvoiceDetails (
  ...
  CONSTRAINT FK_InvoiceDetails_InvoiceID
    FOREIGN KEY (InvoiceID) REFERENCES Invoices(InvoiceID),
  CONSTRAINT FK_InvoiceDetails_ProductNumber
...
VALUES
(1, 'BK-M68S-38', 1, 2319.99, 2319.99),
(1, 'HL-U509-R',  2, 34.99,   69.98),
(2, 'BK-R89B-52', 1, 2443.35, 2443.35),
(3, 'BK-T79U-50', 2, 2145.66, 4291.32),
(3, 'BK-R89B-52', 2, 2199.01, 4398.02),
(3, 'HL-U509',    2, 31.49,   62.98);
